...
@section('content')
    ...
    <div class="single-page-header freelancer-header" data-background-image="{{asset('_landing/images/single-freelancer.jpg')}}">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="single-page-header-inner">
                        <div class="left-side">
                            <div class="header-image freelancer-avatar"><img src="{{asset('_landing/images/user-avatar-big-02.jpg')}}" alt=""></div>
                            <div class="header-details">
                                <h3>{{$seller->name}} <span>Photographer</span></h3>
                                <ul>
                                    <li><div class="star-rating" data-rating="5.0"></div></li>
                                    <li><img class="flag" src="{{asset('_landing/images/flags/de.svg')}}" alt=""> Germany</li>
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 content-right-offset">
                ...
                <div class="single-page-section">
                    <h3 class="margin-bottom-25">About {{''.$seller->name}}</h3>
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="sidebar-container">
                    ...
                    <div class="profile-overview">
                        ...
                        <div class="overview-item"><strong>53</strong><span>Total number of Uploads</span></div>
                        <div class="overview-item"><strong>22</strong><span>Rehired</span></div>
                    </div>

                    <!-- Button -->
                    <a href="#small-dialog" class="apply-now-button popup-with-zoom-anim margin-bottom-50">Message {{''.$seller->name}} <i class="icon-material-outline-arrow-right-alt"></i></a>
            ...
            <div class="popup-tabs-container">
                ...
                <div class="popup-tab-content" id="tab">
                    ...
                    <div class="welcome-text">
                        <h3>Discuss your project with {{$seller->name}}</h3>
                    </div>

                    <!-- Form -->
                    <form method="post" action="{{route('drop-message',['id' => $seller->id])}}">
                        @csrf
                        @if(count($errors)>0)
