...
@section('content')
    <div class="dashboard-content-container" data-simplebar>
        <div class="dashboard-content-inner" >
            ...
            <!-- Row -->
            <div class="row">
                <form method="post" action="{{route('upload_pictures', ['id' => Auth::user()->id] )}}" enctype="multipart/form-data" id="upload_photos">
                    @csrf
                    <!-- Dashboard Box -->
                    @if(count($errors)>0)
                    ...
                    <div class="col-xl-12">
                        <div class="alert alert-info">
                            <i class="icon-feather-folder-plus"></i> You are to upload 5 Photos in which 3 photos must be uploaded as free or basic
                        </div>
                        ...
                        <div class="dashboard-box margin-top-0">
                            <div class="tab-content">
                                @for($i = 1 ; $i<6; $i++)
                                   <div class="container @if($i==1) @endif upload_tabs_content" id="tabs{{$i}}">
                                               ...
                                               <div class="col-xl-4">
                                                   <div class="submit-field">
                                                       <div class="uploadButton margin-top-30">
                                                           <input class=" {{'uploadButton-input'.$i}}" type="file"  accept="image/*" name="{{'image'.$i}}" id="{{'upload'.$i}}"/>
                                                           <label class="uploadButton-button ripple-effect" for="{{'upload'.$i}}">Select Image</label>
                                                           <small class="{{'uploadButton-file-name'.$i}}"></small>
