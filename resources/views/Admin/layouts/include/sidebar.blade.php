    ...
    <div class="nav-list">
        <div class="pcoded-inner-navbar main-menu">
            ...
            <ul class="pcoded-item pcoded-left-item">
                <li class="pcoded-hasmenu {{ (Route::currentRouteName()== "admin.dashboard") ? "active" : "" }}">
                    <a href="{{route('admin.dashboard')}}" id="dashboard_link">
                        <span class="pcoded-micon"><i class="feather icon-home"></i></span>
                        <span class="pcoded-mtext">Dashboard</span>
                    </a>
                    <ul class="pcoded-submenu d-none">
                        <li class="active">
                ...
                <li class="pcoded-hasmenu {{ (Route::currentRouteName()== "admin.user-management") ? "active" : "" }}">
                    <a href="{{route('admin.user-management')}}" id="user_management" class="waves-effect waves-dark">
                ...
                <li class=" {{ (Route::currentRouteName()== "admin.user-upload") ? "active" : "" }}">
                    <a href="{{route('admin.user-upload')}}" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
        										<i class="fa fa-upload"></i>
        									</span>
                        <span class="pcoded-mtext">User's Upload</span>
                    </a>
                </li>
                <li class="{{ (Route::currentRouteName()== "admin.update-category") ? "active" : "" }}">
                    <a href="{{route('admin.update-category')}}" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
        										<i class="fa fa-edit"></i>
        									</span>
                        <span class="pcoded-mtext">Picture category</span>
                    </a>
                </li>
                <li class="{{ (Route::currentRouteName()== "admin.withdrawal-request") ? "active" : "" }}">
                    <a href="{{route('admin.withdrawal-request')}}" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
        										<i class="fa fa-dollar-sign"></i>
        									</span>
                        <span class="pcoded-mtext">Withdrawal Request</span>
                    </a>
                </li>
                <li class="{{ (Route::currentRouteName()== "admin.bank-details") ? "active" : "" }}">
                    <a href="{{route('admin.bank-details')}}" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
                ...
                <li class="{{ (Route::currentRouteName()== "admin.system_settings") ? "active" : "" }}">
                    <a href="{{route('admin.system_settings')}}" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
            ...
            <div class="pcoded-navigation-label d-none">UI Element</div>
            ...
            <div class="pcoded-navigation-label d-none">Forms</div>
            <ul class="pcoded-item pcoded-left-item d-none">
                <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
            ...
            <div class="pcoded-navigation-label d-none">Tables</div>
            <ul class="pcoded-item pcoded-left-item d-none">
                <li class="pcoded-hasmenu">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
            ...
            <div class="pcoded-navigation-label d-none">Chart And Maps</div>
            <ul class="pcoded-item pcoded-left-item d-none">
                <li class="pcoded-hasmenu ">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
            ...
            <div class="pcoded-navigation-label d-none">Pages</div>
            <ul class="pcoded-item pcoded-left-item d-none">
                <li class="pcoded-hasmenu ">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
            ...
            <div class="pcoded-navigation-label d-none">App</div>
            <ul class="pcoded-item pcoded-left-item d-none">
            ...
            <div class="pcoded-navigation-label d-none">Extension</div>
            <ul class="pcoded-item pcoded-left-item d-none" >
                <li class="pcoded-hasmenu ">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
            ...
            <div class="pcoded-navigation-label d-none">Other</div>
            <ul class="pcoded-item pcoded-left-item d-none">
                <li class="pcoded-hasmenu ">
                    <a href="javascript:void(0)" class="waves-effect waves-dark">
        									<span class="pcoded-micon">
