...
@section('content')
    ...
    <div class="modal-content  col-lg-4 col-md-offset-4">
        <div class="clear"></div>
                    <form id="register-form" action="{{url('/getRegistered')}}" method="post">
                               @csrf
                        @if(count($errors)>0)
                        ...
                        <div class="modal-footer mt-10">
                            ...
                            <div class="col-md-12">
                                <div class="col-md-6">
                                    <a href="{{url('/login/facebook')}}"><button type="button" class="btn btn-facebook btn-block">Facebook</button></a>
                                </div>
                                <div class="col-md-6">
                                    <a href="{{url('/login/google')}}"><button type="button" class="btn btn-facebook btn-block">google</button></a>
                                </div>
                            </div>
