...
$(document).ready(function(){
  ...
  /* global ClipboardJS */
    ...
    var uploadButton2 = {
        $button    : $('.uploadButton-input2'),
        $nameField : $('.uploadButton-file-name2')
    };
    var uploadButton3 = {
        $button    : $('.uploadButton-input3'),
        $nameField : $('.uploadButton-file-name3')
    };
    var uploadButton4 = {
        $button    : $('.uploadButton-input4'),
        $nameField : $('.uploadButton-file-name4')
    };
    var uploadButton5 = {
        $button    : $('.uploadButton-input5'),
        $nameField : $('.uploadButton-file-name5')
    };
    ...
    function _populateFileField2($button) {
        var selectedFile = [];
        for (var i = 0; i < $button.get(0).files.length; ++i) {
            selectedFile.push($button.get(0).files[i].name +'<br>');
        }
        uploadButton2.$nameField.html(selectedFile);
    }


    uploadButton3.$button.on('change',function() {
        _populateFileField3($(this));
    });

    function _populateFileField3($button) {
        var selectedFile = [];
        for (var i = 0; i < $button.get(0).files.length; ++i) {
            selectedFile.push($button.get(0).files[i].name +'<br>');
        }
        uploadButton3.$nameField.html(selectedFile);
    }


    uploadButton4.$button.on('change',function() {
        _populateFileField4($(this));
    });

    function _populateFileField4($button) {
        var selectedFile = [];
        for (var i = 0; i < $button.get(0).files.length; ++i) {
            selectedFile.push($button.get(0).files[i].name +'<br>');
        }
        uploadButton4.$nameField.html(selectedFile);
    }

    uploadButton5.$button.on('change',function() {
        _populateFileField5($(this));
    });

    function _populateFileField5($button) {
        var selectedFile = [];
        for (var i = 0; i < $button.get(0).files.length; ++i) {
            selectedFile.push($button.get(0).files[i].name +'<br>');
        }
        uploadButton5.$nameField.html(selectedFile);
    }
